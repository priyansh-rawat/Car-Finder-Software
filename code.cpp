...
{ char comp[15],ans,ans1,buf;
 cars ret;
 retry:
 cout<<"\nDo you prefer any company(y/n):";cin>>ans;
 if(ans=='y'||ans=='Y')
 { cin.get(buf);
  clrscr();
  cout<<"\nEnter name of the company you     want:";cin.getline(comp,15);
  ret=showcomp(comp);
 }
 else if(ans=='n'||ans=='N')
 { ret=showcar();}
...
{clrscr();
 ...
 cout<<setw(40)<<"Password:";cin.getline(pass,10);
...
cars showcar()
{
 ...
 cout<<"\nEnter budget in lakhs (min."<<setprecision(2)<<min<<" Lakhs):";cin>>budget;
 ifstream fin("Cars.dat",ios::binary);
...
void cars :: compare()
{
 ...
 if (ans=='n'||ans=='N')
 {
  cout<<"\nDo you want to select again:";cin>>ans;
  if (ans=='y'||ans=='Y')
   goto re;
 }
 char abs1[3],abs2[3];
...
void cars :: input()
{
 ...
 cout<<"\nCode:";cin>>code;
 cin.get(ch);
 cout<<"\nCompany:";cin.getline(company,15);
 cout<<"\nName:";cin.getline(name,20);
 cout<<"\nType:";cin.getline(type,20);
 cout<<"\nPrice in lakhs:";cin>>price;
 cin.get(ch);
 cout<<"\nEngine:";cin.getline(eng,30);
 cout<<"\nFuel:";cin.getline(fuel,20);
 cout<<"\nMileage:";cin>>mileage;
 cin.get(ch);
 cout<<"\nTransmission:";cin.getline(transmission,30);
 cout<<"\nDrivetrain:";cin.getline(drvtrain,5);
 cout<<"\nPower:";cin>>hp;
 cout<<"\nBoot Space:";cin>>btspc;
 cout<<"\nABS(1/0):";cin>>abs;
 cout<<"\nAirbags:";cin>>airbags;
 cout<<"\nNo. of seats:";cin>>seats;
 cout<<"\nRating:";cin>>rating;
}
void cars :: output()
{
 ...
 while(cont=='y'||cont=='Y')
 {
  ...
  else if(cd=='d'||cd=='D')
  {
   ...
   while(ans=='Y'||ans=='y')
   {
	...
	remove("Cars.dat");rename("temp.dat","Cars.dat");
	cout<<"\nDo you want to delete more(y/n):";cin>>ans;
   }
  }
  else
   exit(0);
